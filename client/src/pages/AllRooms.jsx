...
const AllRooms = () => {
  ...
  // function to check room matches room type
  const matchesRoomType = (room) => {
    return selectedFilters.roomType.length === 0 || selectedFilters.roomType.includes(room.roomType)
  }
  // function to check room matches selected price range
  ...
  // function to sort room based on selected sort option
  const sortRooms = (a, b) => {
  ...
  // function to filter room list based on selected filters
    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      <div>
        <div className='flex flex-col items-start text-left'>
          ...
          <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Take advantage of our limited-time offers and special packages ro enhace your stay and create unforgettable memories.</p>
        </div>

        {filteredRooms.map((room) => (
          <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-3 last:border-0'>
