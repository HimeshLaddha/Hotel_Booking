...
const Dashboard = () => {
    ...
    const { axios, currency, user, getToken, toast } = useAppContext()
    ...
    return (
        <div>
            <Title align='left' font='outfit' title="Dashboard" subTitle="Monitor your room listings, tract bookings and analyze revenue-all in one place. stay updated with real time insights to insure smooth operations." />
